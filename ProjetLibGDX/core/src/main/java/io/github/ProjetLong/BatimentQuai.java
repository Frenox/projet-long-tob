...
public class BatimentQuai implements Batiment {
    ...
    public BatimentQuai(Viewport viewport){
        ...
        pixmap.setColor( 64 / 255, 36 / 255, 32 / 255, 1f );
        ...
        ButtonStyle ButtonStylePoisson = new ButtonStyle(skin.getDrawable("fish_tab_fish"), skin.getDrawable("fish_tab_fish"), skin.getDrawable("fish_tab_fish"));
        ...
        infos_bateaux.add(new Label("Equipement : ", skin, "HebertBold", Color.WHITE)).top().left().expand().pad(2).row();
        ...
        droite.add(scrollpane_stockage).center().bottom().expand().height(this.fishInv.getWidth() * 1.618f * 0.3f).pad(5).padBottom(5).row();
        ...
        ButtonStyle styleChangerPageDroite = new ButtonStyle(skin.getDrawable("Arrow_right"), skin.getDrawable("Arrow_right"), skin.getDrawable("Arrow_right"));
    ...
    public void draw(VilleScreen screen, int position) {
        ...
        if (this.isOpened) {
            int epsilon = 8; 
            screen.jeu.batch.draw(this.pixmaptex, screen.jeu.viewport.getWorldWidth() / 2 - width / 2, screen.jeu.viewport.getWorldHeight() / 2 - height / 2 + epsilon);
            screen.jeu.HebertBold.draw(screen.jeu.batch, "QUAI", screen.jeu.viewport.getWorldWidth() / 2 - width / 2 + 15, screen.jeu.viewport.getWorldHeight() / 2 + height / 2 - 8 + epsilon);
        }
    ...
    public class ButtonBateau extends Button{
        ...
        public ButtonBateau(ButtonStyle buttonStyle, int i) {
            ...
            TextButtonStyle style = new TextButtonStyle(skin1.getDrawable("Rectangle"), skin1.getDrawable("Rectangle"), skin1.getDrawable("Rectangle"), HebertBold);
