...
import io.github.ProjetLong.Bateaux.Corvette;
import io.github.ProjetLong.Bateaux.Fregate;
import io.github.ProjetLong.Bateaux.Vaisseau;
...
public class SerializerBateau extends SerializerBaseClass<Bateau> {
    ...
    public Bateau deserializeElement(String element, int compositionLevel) {
        try {
            ...
            List<CanneAPeche> listeCannes = canneAPecheSerializer.deserializeListData(bateauData[4],
                    compositionLevel + 1);
