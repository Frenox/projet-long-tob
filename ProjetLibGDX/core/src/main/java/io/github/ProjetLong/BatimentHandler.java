...
public class BatimentHandler {
    ...
    public void input(VilleScreen screen) {
        ...
        //gestion de l'input barre espace (ouvre le batiment devant lequel le joueur se trouve, sauf si c'est un bâtiment fictif)
        ...
        //changement du sens du personnage si une seule des deux flêches directionnelles est pressée
    ...
    public void logic(VilleScreen screen) {
        ...
        //chargement des bâtiments stocké dans le data manager (fait à chaque itération si déblocage de bâtiment)
        loadBatimentList();
